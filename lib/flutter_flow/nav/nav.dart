...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: SoloGameWidget.routeName,
          path: SoloGameWidget.routePath,
          builder: (context, params) => SoloGameWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: LogWidget.routeName,
          path: LogWidget.routePath,
          builder: (context, params) =>
              params.isEmpty ? NavBarPage(initialPage: 'Log') : LogWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: GameSummaryWidget.routeName,
          path: GameSummaryWidget.routePath,
          builder: (context, params) => GameSummaryWidget(),
        ),
        FFRoute(
          name: DailyChallengeWidget.routeName,
          path: DailyChallengeWidget.routePath,
          builder: (context, params) => DailyChallengeWidget(),
        ),
        FFRoute(
          name: GameSummaryDCWidget.routeName,
          path: GameSummaryDCWidget.routePath,
          builder: (context, params) => GameSummaryDCWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: SelectOpponentWidget.routeName,
          path: SelectOpponentWidget.routePath,
          builder: (context, params) => SelectOpponentWidget(),
        )
